...
(function () {
  ...
  function Canvas (input) {
    ...
    this.plotRegularPoly = function (x, y, r, sides, counterClockwise) {
      if (!sides > 3) {
        return this;
      }
      ...
      for (var i = 0; i < sides; i += direction) {
    ...
    this.strokeRegularPoly = function (x, y, r, sides, counterClockwise, color) {
      if (!sides > 3) {
        return this;
      }

      return this
        .plotRegularPoly(x, y, r, sides, counterClockwise)
        .setStroke(color)
        .stroke();
    }.bind(this);

    this.fillRegularPoly = function (x, y, r, sides, counterClockwise, color) {
      if (!sides > 3) {
        return this;
      }
