...
(function () {
  ...
  function Canvasimo (input) {
    ...
    var lastArgIsColorString = lastArgIs.bind(this, isColorString);
    var lastArgIsString = lastArgIs.bind(this, isString);
