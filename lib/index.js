...
(function () {
  ...
  function Canvasimo (input) {
    ...
    this.fill = function () {
      ...
      if (args.length === 1 && typeof args[0] === 'string' && !isSpecialFill.exec(args[0])) {
        this.setFill(args[0]);
        ctx.fill();
        return this;
      } else if (args.length === 2 && typeof args[1] === 'string' && !isSpecialFill.exec(args[1])) {
        this.setFill(args[1]);
        ctx.fill(args[0]);
        return this;
      }
    ...
    this.stroke = function () {
      ...
      if (args.length === 1 && typeof args[0] === 'string') {
        this.setStroke(args[0]);
        ctx.stroke();
        return this;
      } else if (args.length === 2 && typeof args[1] === 'string') {
        this.setStroke(args[1]);
        ctx.stroke(args[0]);
        return this;
      }
    ...
    this.clearCanvas = function () {
      return this
        .resetTransform()
        .clearRect(0, 0, this.getWidth(), this.getHeight());
    }.bind(this);
