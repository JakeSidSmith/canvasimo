...
(function () {
  ...
  function Canvasimo (input) {
    ...
    this.getContext = function (contextType, contextAttributes) {
      return element.getContext(contextType, contextAttributes);
    };
    ...
    this.plotRect = this.rect = canvasAction.bind(this, 'rect');
    this.plotArc = this.arc = canvasAction.bind(this, 'arc');
    this.plotEllipse = this.ellipse = canvasAction.bind(this, 'ellipse');

    // Changed to stroke to match other stroke functions
    this.setStrokeDash = this.setLineDash = canvasAction.bind(this, 'setLineDash');
    ...
    // Standard getters
    this.getContextAttributes = canvasGetter.bind(this, 'getContextAttributes');
    this.getImageData = canvasGetter.bind(this, 'getImageData');

    // Standard creators
    this.createLinearGradient = canvasGetter.bind(this, 'createLinearGradient');
    this.createRadialGradient = canvasGetter.bind(this, 'createRadialGradient');
    this.createPattern = canvasGetter.bind(this, 'createPattern');
    this.createImageData = canvasGetter.bind(this, 'createImageData');

    // Standard checkers
    this.isPointInPath = canvasGetter.bind(this, 'isPointInPath');
    this.isPointInStroke = canvasGetter.bind(this, 'isPointInStroke');

    // Standard measure text
    this.getTextSize = canvasGetter.bind(this, 'measureText');

    // Changed to stroke to match other stroke functions
    this.getStrokeDash = canvasGetter.bind(this, 'getLineDash');
  ...
  if (typeof exports !== 'undefined') {
    if (typeof module !== 'undefined' && module.exports) {
      exports = module.exports = Canvasimo;
    }
