...
(function () {
  ...
  function Canvasimo (input) {
    ...
    // Canvas basic action
    function canvasAction (key) {
      ctx[key].apply(ctx, Array.prototype.slice.call(arguments, 1));
      return this;
    };
    ...
    function canvasGetter (key) {
      return ctx[key].apply(ctx, Array.prototype.slice.call(arguments, 1));
    }
