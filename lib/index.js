...
(function () {
  ...
  function Canvas (input) {
    ...
    this.plotStar = function (x, y, r1, r2, sides, counterClockwise) {
      sides = Math.round(parseFloat(sides));
    ...
    this.strokeStar = function (x, y, r1, r2, sides, counterClockwise, color) {
      sides = Math.round(parseFloat(sides));
      ...
      return this
        .plotStar(x, y, r1, r2, sides, counterClockwise)
        .setStroke(color)
        .stroke();
    }.bind(this);

    this.fillStar = function (x, y, r1, r2, sides, counterClockwise, color) {
      sides = Math.round(parseFloat(sides));
