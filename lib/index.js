  ...
  function Canvas (input) {
    ...
    this.plotRoundedRect = function (x, y, width, height, radius) {
      ...
      return this
        ...
        .bezierCurveTo(x + width - minRadius / 2, y, x + width, y + minRadius / 2, x + width, y + minRadius)
        .lineTo(x + width, y + height - minRadius)
        .bezierCurveTo(x + width, y + height - minRadius / 2, x + width - minRadius / 2, y + height, x + width - minRadius, y + height)
        .lineTo(x + minRadius, y + height)
        .bezierCurveTo(x + minRadius / 2, y + height, x, y + height - minRadius / 2, x, y + height - minRadius)
        .lineTo(x, y + minRadius)
        .bezierCurveTo(x, y + minRadius / 2, x + minRadius / 2, y, x + minRadius, y)
        .endPath();
      return this;
    }.bind(this);
